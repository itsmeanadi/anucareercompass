  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-[#1f3445] mb-2">Career Intent & Learning</h2>
        <p className="text-[#1f3445] font-medium">Define your goals and learning preferences</p>
      </div>

      {/* Primary Goal */}
      <div className="space-y-4">
        <Label className="text-base font-bold text-[#1f3445]">Primary Goal</Label>
        <RadioGroup 
        ...
        >
          {goals.map((goal) => (
            <div key={goal.value} className="relative">
              ...
              >
                <goal.icon className="w-7 h-7 text-[#1f3445]" />
                <span className="font-semibold">{goal.label}</span>
                <span className="text-xs text-[#1f3445]/80 text-center">{goal.desc}</span>
              </Label>
            </div>
          ))}
        </RadioGroup>
      ...
      {/* Target Companies */}
      <div className="space-y-4">
        <Label className="text-base font-bold text-[#1f3445]">Target Companies / Roles (Optional)</Label>
      ...
      <div className="space-y-4">
        <div className="flex justify-between">
          <Label className="text-base font-bold text-[#1f3445]">Weekly Time for Skill Growth</Label>
          <span className="text-sm font-bold text-[#1f3445]">{data.weeklyCommitmentHours} hours</span>
        </div>
        <Slider
      ...
      {/* Learning Style */}
      <div className="space-y-4">
        <Label className="text-base font-bold text-[#1f3445]">Learning Style Preference</Label>
        <RadioGroup 
          ...
          {learningStyles.map((style) => (
            <div key={style.value} className="relative">
              ...
              <Label 
                ...
                className="flex flex-col items-center gap-2 p-5 rounded-xl border-2 border-border cursor-pointer transition-all peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/5 hover:border-primary/50"
              >
                <style.icon className="w-6 h-6 text-[#1f3445]" />
                <span className="text-sm font-bold text-center text-[#1f3445]">{style.label}</span>
              </Label>
            </div>
          ))}
        </RadioGroup>
