  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-[#1f3445] mb-2">Logistics & Preferences</h2>
        <p className="text-[#1f3445] font-medium">Set your preferences and constraints</p>
      </div>

      {/* Internship Type Preference */}
      <div className="space-y-4">
        <Label className="text-base font-bold text-[#1f3445]">Internship Type Preference</Label>
        <RadioGroup 
        ...
        >
          {[
            ...
            <div key={option.value} className="relative">
              ...
              >
                <option.icon className="w-8 h-8 text-[#1f3445]" />
                <span className="font-semibold">{option.label}</span>
                <span className="text-xs text-[#1f3445]/80">{option.desc}</span>
              </Label>
            </div>
          ))}
        </RadioGroup>
      ...
      <div className="space-y-3">
        <Label className="text-base font-bold text-[#1f3445]">Preferred Duration</Label>
        <RadioGroup 
        ...
        >
          {["1–2 Months", "3–4 Months", "6+ Months"].map((duration) => (
            <div key={duration} className="flex items-center space-x-2">
              ...
              <Label htmlFor={`duration-${duration}`} className="cursor-pointer font-medium text-[#1f3445]">{duration}</Label>
            </div>
          ))}
        </RadioGroup>
      </div>
      ...
      <div className="space-y-3">
        <Label className="text-base font-bold text-[#1f3445]">Interest in Government Internships</Label>
        <RadioGroup 
      ...
      <div className="space-y-4">
        <Label className="text-base font-bold text-[#1f3445]">Relocation Readiness</Label>
        <RadioGroup 
        ...
        >
          {[
            ...
            <div key={option.value} className="relative">
              ...
              >
                <option.icon className="w-6 h-6 text-[#1f3445]" />
                <span className="text-sm font-bold text-center text-[#1f3445]">{option.label}</span>
              </Label>
            </div>
          ))}
        </RadioGroup>
