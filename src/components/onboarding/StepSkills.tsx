  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-[#1f3445] mb-2">Domain & Skills</h2>
        <p className="text-[#1f3445] font-medium">Tell us about your skills and target domains</p>
      </div>

      {/* Target Industries */}
      <div className="space-y-3">
        <Label className="text-base font-bold text-[#1f3445]">Target Industry (Select all that apply)</Label>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {industries.map((industry) => (
            <div key={industry.id} className="flex items-center space-x-3">
              ...
              />
              <Label htmlFor={industry.id} className="cursor-pointer font-medium text-[#1f3445]">{industry.label}</Label>
            </div>
          ))}
        </div>
      </div>
      ...
      {data.targetIndustries.includes("core") && (
        <div className="space-y-3">
          <Label className="text-base font-bold text-[#1f3445]">Core Engineering Specialization</Label>
      ...
      <div className="space-y-3">
        <Label className="text-base font-bold text-[#1f3445]">Primary Technical Strength</Label>
        <RadioGroup 
        ...
        >
          {technicalStrengths.map((strength) => (
            <div key={strength} className="flex items-center space-x-2">
              ...
              <Label htmlFor={`strength-${strength}`} className="cursor-pointer font-medium text-[#1f3445]">{strength}</Label>
            </div>
          ))}
        </RadioGroup>
      </div>
      ...
      {/* Secondary Skills */}
      <div className="space-y-3">
        <Label className="text-base font-bold text-[#1f3445]">Secondary Skill Areas</Label>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {secondarySkillOptions.map((skill) => (
            <div key={skill} className="flex items-center space-x-3">
              ...
              />
              <Label htmlFor={`secondary-${skill}`} className="cursor-pointer font-medium text-[#1f3445]">{skill}</Label>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="space-y-3">
        <Label className="text-base font-bold text-[#1f3445]">Certification Status</Label>
        <RadioGroup 
        ...
        >
          {["3+ Industry Certifications", "1–2 Industry Certifications", "No Certifications yet"].map((status) => (
            <div key={status} className="flex items-center space-x-2">
              ...
              <Label htmlFor={`cert-${status}`} className="cursor-pointer font-medium text-[#1f3445]">{status}</Label>
            </div>
          ))}
        </RadioGroup>
      </div>
      ...
      <div className="space-y-3">
        <Label className="text-base font-bold text-[#1f3445]">Project Experience Level</Label>
        <RadioGroup 
        ...
        >
          {[
            ...
            <div key={level} className="flex items-center space-x-2">
              ...
              <Label htmlFor={`project-${level}`} className="cursor-pointer font-medium text-[#1f3445]">{level}</Label>
            </div>
          ))}
        </RadioGroup>
      </div>
